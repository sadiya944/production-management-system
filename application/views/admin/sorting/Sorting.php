            ...
            <div class="card my-2">
                ...
                <div class="table-responsive p-0">
                    ...
                    <?php if (!empty($sorting)) : $i = 1; foreach ($sorting as $value) : ?>
                        ...
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->qty_target; ?> /sets</span>
                        </td>
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->finished; ?> sets</span>
                        </td>
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->waste; ?> sets</span>
                        </td>
                        <td>
