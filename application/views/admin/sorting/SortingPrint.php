            ...
            <div class="row">
                <div class="col-6 p-3">
                        <div class="col align-items-center">
                            ...
                            <span class="text-xl"><b><?= $detail['finished']?></b> sets</br></span>
                            <span class="text-sm mb-0">Detail on this production</span>
                        </div>
                </div>
                <div class="col-6 p-3">
                        <div class="col align-items-center">
                            ...
                            <span class="text-xl"><b><?= $detail['waste']?></b> sets</br> </span>
                            <span class="text-sm mb-0">Detail on this production</span>
                        </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <ul class="list-group">
                        ...
                        <div class="pl-5 d-flex flex-column">
                            ...
                            <span class="mb-3 text-sm">Target : </br><b><?= $detail['qty_target']?> sets/Shift</b></span>
                        </div>
                        </li>
                    </ul>
                    </div>
              ...
              <div class="card mt-4">
                ...
                <div class="table-responsive p-0">
                    ...
                    <?php if (!empty($p_material)) : $i = 1; foreach ($p_material as $value) : ?>
                        ...
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->used_stock?> sets</span> </br>
                        </td>
          ...
          <div class="card pb-4">
            ...
            <div class="table-responsive">
                    ...
                    <?php if (!empty($p_machine)) : $i = 1; foreach ($p_machine as $value) : ?>
                        ...
                        <td class="">
                            <span class="text-sm font-weight-bold"><?= $value->capacity?> sets</span> </br>
                        </td>
                        <?php  endforeach; endif;?>
                        </tr>
                    </tbody>
